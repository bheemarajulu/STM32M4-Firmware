...
int main(void)
{
  ...
  /* convert the ADC value (from 0 to 0xFFF) to a voltage value (from 0V to 3.3V)*/
    ADC3ConvertedVoltage = ADC3ConvertedValue *3300/0xFFF;
		...
		USART_SendData(USART2, (uint8_t) ADC3ConvertedVoltage >> 24);

		/* Loop until the end of transmission */
		while (USART_GetFlagStatus(USART2, USART_FLAG_TC) == RESET)
		{}
	
		USART_SendData(USART2, (uint8_t) ADC3ConvertedVoltage >> 16);

		/* Loop until the end of transmission */
		while (USART_GetFlagStatus(USART2, USART_FLAG_TC) == RESET)
		{}
  
		USART_SendData(USART2, (uint8_t) ADC3ConvertedVoltage >> 8);

		/* Loop until the end of transmission */
		while (USART_GetFlagStatus(USART2, USART_FLAG_TC) == RESET)
		{}
	
		USART_SendData(USART2, (uint8_t) ADC3ConvertedVoltage);
